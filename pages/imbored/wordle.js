const WORD_LIST = [
  ...
  "YOUNG","YOURS","YOUTH","ZEBRA","ZESTY","ABASE","ABATE","ABBOT","ABHOR","ABIDE","ABLED","ABODE","ABORT","ABOVE","ABYSS",
  "ACORN","ACRID","ACTED","ACTIN","ACTOR","ACORN","ACRES","ACIDS","ACORN","ADAGE",
  "ADDED","ADDER","ADEPT","ADORE","ADORN","ADULT","AEGIS","AFOOT","AFOUL","AFTER",
  "AGATE","AGILE","AGING","AGLOW","AGONY","AGREE","AIDER","AISLE","ALARM","ALGAE",
  "ALIBI","ALIEN","ALIGN","ALLOT","ALLOY","ALOFT","ALOUD","ALPHA","ALTAR","AMASS",
  "AMAZE","AMBER","AMEND","AMISS","AMONG","AMPLE","AMPLY","AMUSE","ANGST","ANODE",
  "ANTIC","ANTSY","APEXX","APHID","APING","APRON","APTLY","ARBOR","ARDOR","AREAL",
  "ARGON","AROMA","AROSE","ARRAY","ARROW","ASHEN","ASHES","ASIDE","ASPEN","ASSAY",
  "ASTER","ATOLL","ATONE","ATTAR","AUGER","AUNTY","AVAIL","AVERT","AVIAN","AVOID",
  "AWAIT","AWOKE","AXIAL","AXIOM","AZURE","BACON","BADGE","BADLY","BAGEL","BAGGY",
  "BAKER","BALER","BALMY","BANJO","BARON","BASAL","BASER","BASIL","BASIN","BASIS",
  "BASSY","BATTY","BAYOU","BEADY","BEARD","BEAST","BEEFY","BEFIT","BEGAN","BEGET",
  "BEGIN","BEGUN","BEIGE","BELCH","BELIE","BELLE","BELLY","BELOW","BENCH","BERRY",
  "BERTH","BICEP","BIDDY","BIGHT","BINGO","BIRCH","BISON","BITTY","BLACK","BLADE",
  "BLIMP","BLINK","BLISS","BLITZ","BLOAT","BLOKE","BLOND","BLUER","BLUFF","BLUNT",
  "BLURB","BLURT","BLUSH","BOARD","BOAST","BOBBY","BONEY","BONNY","BOOBY","BOOST",
  "BOOZE","BORAX","BORNE","BOSOM","BOSSY","BOTCH","BOUGH","BOULE","BOUNC","BOUND",
  "BOWEL","BOXER","BRACE","BRAID","BRAKE","BRASH","BRASS","BRIAR","BRIBE","BRINE",
  "BRINY","BRISK","BROAD","BROIL","BROOD","BROTH","BROWN","BRUNT","BRUTE","BUDDY",
  "BUDGE","BUGGY","BUGLE","BUILD","BUILT","BULGE","BULKY","BULLY","BUNCH","BUNNY",
  "BURNT","BURRO","BURRY","BUSHY","BUTTE","BUXOM","BUYER","BYLAW","CABAL","CABBY",
  "CABIN","CABAL","CACAO","CACHE","CACTI","CADDY","CADET","CAGEY","CAIRN","CAMPO",
  "CANAL","CANDY","CANOE","CANON","CAPER","CAPUT","CARAT","CARGO","CAROL","CARVE",
  "CASTE","CATTY","CAUSE","CAVAL","CEASE","CEDAR","CELLO","CHAFE","CHAFF","CHAIN",
  "CHAIR","CHALK","CHAMP","CHANT","CHAOS","CHARD","CHARM","CHART","CHASE","CHASM",
  "CHEAP","CHEAT","CHECK","CHEER","CHESS","CHEST","CHICK","CHIDE","CHILI","CHILL",
  "CHIME","CHINA","CHIRP","CHOCK","CHOIR","CHOKE","CHOMP","CHORD","CHORE","CHUCK",
  "CHURN","CIDER","CIGAR","CINCH","CIRCA","CIVIL","CLACK","CLAIM","CLAMP","CLANG",
  "CLANK","CLASH","CLASP","CLASS","CLEAN","CLEAR","CLEAT","CLERK","CLICK","CLIFF"
];

const OUR_WORD_LIST = [
    "UNION", "DINER", "CLARK", "TAXES", "SHORE", "BAGEL", "DELIS", "PIZZA", "FIELD"
];
